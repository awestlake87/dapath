...
public class ModeProfile {
    ...
    public void setupDaClassic(int width, int height) {
        ...
        this.DaSupaSlowTransTime = TextTrackStyle.DEFAULT_FONT_SCALE;
        ...
        this.AppBarMax = BitmapDescriptorFactory.HUE_CYAN;
        this.InitTimeMult = TextTrackStyle.DEFAULT_FONT_SCALE;
        this.InitScoreMult = TextTrackStyle.DEFAULT_FONT_SCALE;
