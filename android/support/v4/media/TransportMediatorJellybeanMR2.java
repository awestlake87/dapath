...
class TransportMediatorJellybeanMR2 implements OnGetPlaybackPositionListener, OnPlaybackPositionUpdateListener {
    OnAudioFocusChangeListener mAudioFocusChangeListener = new C00254();
    boolean mAudioFocused;
    final AudioManager mAudioManager;
    final Context mContext;
    boolean mFocused;
    final Intent mIntent;
    final BroadcastReceiver mMediaButtonReceiver = new C00243();
    ...
    final OnWindowAttachListener mWindowAttachListener = new C00221();
    final OnWindowFocusChangeListener mWindowFocusListener = new C00232();
