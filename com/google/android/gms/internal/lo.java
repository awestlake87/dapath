...
public interface lo extends IInterface {
    ...
    public static abstract class C0790a extends Binder implements lo {

        private static class C0789a implements lo {
            private IBinder kq;
            ...
            public void mo1898b(int i, int i2, Bundle bundle) throws RemoteException {
        ...
        public static lo bs(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof lo)) ? new C0789a(iBinder) : (lo) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    mo1898b(data.readInt(), data.readInt(), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
    ...
    void mo1898b(int i, int i2, Bundle bundle) throws RemoteException;
}
