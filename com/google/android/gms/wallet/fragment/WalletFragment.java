...
import com.google.android.gms.dynamic.C1029b;
...
public final class WalletFragment extends Fragment {
    ...
    private Boolean ako;
    private C0962b akt;
    private final C1029b aku = C1029b.m3256a(this);
    private final C0963c akv = new C0963c();
    private C1144a akw = new C1144a(this);
    ...
    private static class C0962b implements LifecycleDelegate {
        private final lk akr;

        private C0962b(lk lkVar) {
            this.akr = lkVar;
        }
    ...
    private class C0963c extends C0250a<C0962b> implements OnClickListener {
        final /* synthetic */ WalletFragment akz;

        private C0963c(WalletFragment walletFragment) {
        ...
        protected void mo1945a(C0253f<C0962b> c0253f) {
            Activity activity = this.akz.Mj.getActivity();
            if (this.akz.akt == null && this.akz.mCreated && activity != null) {
                try {
                    this.akz.akt = new C0962b(ls.m2809a(activity, this.akz.aku, this.akz.akk, this.akz.akw));
                    this.akz.akk = null;
                    c0253f.mo1073a(this.akz.akt);
    ...
    static class C1144a extends C0784a {
        private OnStateChangedListener akx;
        private final WalletFragment aky;

        C1144a(WalletFragment walletFragment) {
