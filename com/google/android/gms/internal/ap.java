...
public interface ap extends IInterface {
    ...
    public static abstract class C0672a extends Binder implements ap {

        private static class C0671a implements ap {
            private IBinder kq;
        ...
        public static ap m2457e(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ap)) ? new C0671a(iBinder) : (ap) queryLocalInterface;
        }
