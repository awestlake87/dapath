...
public interface db extends IInterface {
    ...
    public static abstract class C0699a extends Binder implements db {

        private static class C0698a implements db {
            private IBinder kq;
        ...
        public static db m2527p(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof db)) ? new C0698a(iBinder) : (db) queryLocalInterface;
        }
