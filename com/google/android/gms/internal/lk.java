...
public interface lk extends IInterface {
    ...
    public static abstract class C0782a extends Binder implements lk {

        private static class C0781a implements lk {
            private IBinder kq;
            ...
            public void mo1873a(C0252d c0252d, WalletFragmentOptions walletFragmentOptions, Bundle bundle) throws RemoteException {
        ...
        public static lk bo(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof lk)) ? new C0781a(iBinder) : (lk) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    mo1873a(C0661a.ag(data.readStrongBinder()), data.readInt() != 0 ? (WalletFragmentOptions) WalletFragmentOptions.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
    ...
    void mo1873a(C0252d c0252d, WalletFragmentOptions walletFragmentOptions, Bundle bundle) throws RemoteException;
