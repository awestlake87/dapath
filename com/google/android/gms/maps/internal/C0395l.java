...
public interface C0395l extends IInterface {

    public static abstract class C0860a extends Binder implements C0395l {

        private static class C0859a implements C0395l {
            private IBinder kq;
            ...
            public boolean mo2107a(C0420f c0420f) throws RemoteException {
                boolean z = true;
        ...
        public static C0395l aK(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMarkerClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0395l)) ? new C0859a(iBinder) : (C0395l) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    boolean a = mo2107a(C0889a.bc(data.readStrongBinder()));
    ...
    boolean mo2107a(C0420f c0420f) throws RemoteException;
}
