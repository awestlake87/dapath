...
public interface IMapViewDelegate extends IInterface {
    ...
    public static abstract class C0828a extends Binder implements IMapViewDelegate {

        private static class C0827a implements IMapViewDelegate {
            private IBinder kq;
        ...
        public static IMapViewDelegate aC(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapViewDelegate)) ? new C0827a(iBinder) : (IMapViewDelegate) queryLocalInterface;
        }
