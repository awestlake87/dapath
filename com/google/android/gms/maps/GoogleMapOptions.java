...
import com.google.android.gms.maps.internal.C0384a;
...
public final class GoogleMapOptions implements SafeParcelable {
    ...
    GoogleMapOptions(int versionCode, byte zOrderOnTop, byte useViewLifecycleInFragment, int mapType, CameraPosition camera, byte zoomControlsEnabled, byte compassEnabled, byte scrollGesturesEnabled, byte zoomGesturesEnabled, byte tiltGesturesEnabled, byte rotateGesturesEnabled) {
        this.Zu = -1;
        this.xM = versionCode;
        this.Zs = C0384a.m1485a(zOrderOnTop);
        this.Zt = C0384a.m1485a(useViewLifecycleInFragment);
        this.Zu = mapType;
        this.Zv = camera;
        this.Zw = C0384a.m1485a(zoomControlsEnabled);
        this.Zx = C0384a.m1485a(compassEnabled);
        this.Zy = C0384a.m1485a(scrollGesturesEnabled);
        this.Zz = C0384a.m1485a(zoomGesturesEnabled);
        this.ZA = C0384a.m1485a(tiltGesturesEnabled);
        this.ZB = C0384a.m1485a(rotateGesturesEnabled);
    }
    ...
    public static GoogleMapOptions createFromAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attrs, C0100R.styleable.MapAttrs);
    ...
    byte jq() {
        return C0384a.m1486c(this.Zs);
    }

    byte jr() {
        return C0384a.m1486c(this.Zt);
    }

    byte js() {
        return C0384a.m1486c(this.Zw);
    }

    byte jt() {
        return C0384a.m1486c(this.Zx);
    }

    byte ju() {
        return C0384a.m1486c(this.Zy);
    }

    byte jv() {
        return C0384a.m1486c(this.Zz);
    }

    byte jw() {
        return C0384a.m1486c(this.ZA);
    }

    byte jx() {
        return C0384a.m1486c(this.ZB);
    }
