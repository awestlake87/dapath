...
public abstract class WearableListenerService extends Service implements DataListener, MessageListener, NodeListener {
    ...
    private class C1145a extends C0977a {
        final /* synthetic */ WearableListenerService alu;

        private C1145a(WearableListenerService wearableListenerService) {
            this.alu = wearableListenerService;
        }

        public void mo2379Y(final DataHolder dataHolder) {
        ...
        public void mo2380a(final af afVar) {
            if (Log.isLoggable("WearableLS", 3)) {
        ...
        public void mo2381a(final ai aiVar) {
            if (Log.isLoggable("WearableLS", 3)) {
        ...
        public void mo2382b(final ai aiVar) {
            if (Log.isLoggable("WearableLS", 3)) {
