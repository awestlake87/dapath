...
public interface C0416b extends IInterface {

    public static abstract class C0881a extends Binder implements C0416b {

        private static class C0880a implements C0416b {
            private IBinder kq;
            ...
            public boolean mo2142a(C0416b c0416b) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.ICircleDelegate");
                    obtain.writeStrongBinder(c0416b != null ? c0416b.asBinder() : null);
        ...
        public static C0416b aY(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.ICircleDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0416b)) ? new C0880a(iBinder) : (C0416b) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 17:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.ICircleDelegate");
                    isVisible = mo2142a(C0881a.aY(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
    ...
    boolean mo2142a(C0416b c0416b) throws RemoteException;
