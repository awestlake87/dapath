...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        public void readGroup(AttributeSet attrs) {
            TypedArray a = SupportMenuInflater.this.mContext.obtainStyledAttributes(attrs, C0067R.styleable.MenuGroup);
        ...
        public void readItem(AttributeSet attrs) {
            TypedArray a = SupportMenuInflater.this.mContext.obtainStyledAttributes(attrs, C0067R.styleable.MenuItem);
            this.itemId = a.getResourceId(2, 0);
            this.itemCategoryOrder = (SupportMenu.CATEGORY_MASK & a.getInt(5, this.groupCategory)) | (65535 & a.getInt(6, this.groupOrder));
