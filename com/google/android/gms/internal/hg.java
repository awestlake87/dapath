...
public interface hg extends IInterface {
    ...
    public static abstract class C0750a extends Binder implements hg {

        private static class C0749a implements hg {
            private IBinder kq;
        ...
        public static hg m2668J(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof hg)) ? new C0749a(iBinder) : (hg) queryLocalInterface;
        }
