...
public final class DataHolder implements SafeParcelable {
    public static final C0161f CREATOR = new C0161f();
    private static final C0157a EO = new C0157a(new String[0], null) {
    };
    ...
    public static class C0157a {
        ...
        private C0157a(String[] strArr, String str) {
    ...
    private DataHolder(C0157a builder, int statusCode, Bundle metadata) {
    ...
    private static CursorWindow[] m2006a(C0157a c0157a, int i) {
        int size;
        int i2 = 0;
        if (c0157a.EG.length == 0) {
            return new CursorWindow[0];
        }
        List b = (i < 0 || i >= c0157a.EP.size()) ? c0157a.EP : c0157a.EP.subList(0, i);
        int size2 = b.size();
        CursorWindow cursorWindow = new CursorWindow(false);
        ArrayList arrayList = new ArrayList();
        arrayList.add(cursorWindow);
        cursorWindow.setNumColumns(c0157a.EG.length);
        int i3 = 0;
        int i4 = 0;
        while (i3 < size2) {
            int i5;
            ...
            boolean z = true;
            for (int i7 = 0; i7 < c0157a.EG.length && z; i7++) {
                String str = c0157a.EG[i7];
            ...
            if (z) {
                ...
                try {
                    ...
                    cursorWindow3.setNumColumns(c0157a.EG.length);
