...
public interface C0391h extends IInterface {

    public static abstract class C0852a extends Binder implements C0391h {

        private static class C0851a implements C0391h {
            private IBinder kq;
            ...
            public void mo2103k(C0252d c0252d) throws RemoteException {
        ...
        public static C0391h aG(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0391h)) ? new C0851a(iBinder) : (C0391h) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    mo2103k(C0661a.ag(data.readStrongBinder()));
    ...
    void mo2103k(C0252d c0252d) throws RemoteException;
}
