...
class ah implements C0121n {
    ...
    public int mo842a(List<C0139x> list, ab abVar, boolean z) {
        int i = 0;
        ...
        while (i3 < min) {
            int i4;
            URL url2;
            C0139x c0139x = (C0139x) list.get(i3);
            URL a = m1895a(c0139x);
            if (a == null) {
                if (aa.dp()) {
                    aa.m40D("No destination: discarding hit: " + c0139x.dk());
                } else {
                ...
                String a2 = TextUtils.isEmpty(c0139x.dk()) ? "" : C0140y.m87a(c0139x, System.currentTimeMillis());
    ...
    URL m1895a(C0139x c0139x) {
        if (this.xc != null) {
            return this.xc;
        }
        try {
            return new URL("http:".equals(c0139x.dn()) ? "http://www.google-analytics.com/collect" : "https://ssl.google-analytics.com/collect");
        } catch (MalformedURLException e) {
