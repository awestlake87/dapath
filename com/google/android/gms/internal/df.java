...
public interface df extends IInterface {
    ...
    public static abstract class C0707a extends Binder implements df {

        private static class C0706a implements df {
            private IBinder kq;
        ...
        public static df m2533t(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof df)) ? new C0706a(iBinder) : (df) queryLocalInterface;
        }
