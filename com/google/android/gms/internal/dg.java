...
import com.google.android.gms.internal.df.C0707a;

public interface dg extends IInterface {

    public static abstract class C0709a extends Binder implements dg {

        private static class C0708a implements dg {
            private IBinder kq;
            ...
            public void mo1680a(df dfVar) throws RemoteException {
        ...
        public static dg m2535u(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof dg)) ? new C0708a(iBinder) : (dg) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.ads.internal.purchase.client.IPlayStorePurchaseListener");
                    mo1680a(C0707a.m2533t(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void mo1680a(df dfVar) throws RemoteException;
