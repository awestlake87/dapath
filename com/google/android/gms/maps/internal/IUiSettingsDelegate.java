...
public interface IUiSettingsDelegate extends IInterface {
    ...
    public static abstract class C0838a extends Binder implements IUiSettingsDelegate {

        private static class C0837a implements IUiSettingsDelegate {
            private IBinder kq;
        ...
        public static IUiSettingsDelegate aW(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IUiSettingsDelegate)) ? new C0837a(iBinder) : (IUiSettingsDelegate) queryLocalInterface;
        }
