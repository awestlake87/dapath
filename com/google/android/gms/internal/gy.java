...
public final class gy {
    ...
    private final C0744a FU;

    public static final class C0744a implements SafeParcelable {
        ...
        C0744a(int i, String str, List<String> list, int i2, String str2) {
        ...
        public C0744a(String str, Collection<String> collection, int i, String str2) {
    ...
    public gy(String str, Collection<String> collection, int i, View view, String str2) {
        this.FU = new C0744a(str, collection, i, str2);
        this.DJ = view;
    }
