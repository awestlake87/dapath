...
public final class BitmapDescriptorFactory {
    ...
    private static C0415a aam;

    private BitmapDescriptorFactory() {
    }

    public static void m1510a(C0415a c0415a) {
        if (aam == null) {
            aam = (C0415a) hm.m1232f(c0415a);
        }
    }
    ...
    public static BitmapDescriptor defaultMarker(float hue) {
        try {
            return new BitmapDescriptor(jM().mo2139c(hue));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public static BitmapDescriptor fromBitmap(Bitmap image) {
        try {
            return new BitmapDescriptor(jM().mo2135b(image));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    private static C0415a jM() {
        return (C0415a) hm.m1228b(aam, (Object) "IBitmapDescriptorFactory is not initialized");
    }
}
