...
public interface de extends IInterface {
    ...
    public static abstract class C0705a extends Binder implements de {

        private static class C0704a implements de {
            private IBinder kq;
            ...
            public IBinder mo1674b(C0252d c0252d) throws RemoteException {
        ...
        public static de m2532s(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof de)) ? new C0704a(iBinder) : (de) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    IBinder b = mo1674b(C0661a.ag(data.readStrongBinder()));
    ...
    IBinder mo1674b(C0252d c0252d) throws RemoteException;
}
