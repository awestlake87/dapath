...
public interface ix extends IInterface {
    ...
    public static abstract class C0762a extends Binder implements ix {

        private static class C0761a implements ix {
            private IBinder kq;
            ...
            public void mo1797g(int i, Bundle bundle) throws RemoteException {
        ...
        public static ix ao(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ix)) ? new C0761a(iBinder) : (ix) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 2:
                    ...
                    mo1797g(data.readInt(), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
    ...
    void mo1797g(int i, Bundle bundle) throws RemoteException;
}
