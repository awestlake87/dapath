...
public class C1158m implements SafeParcelable, DataItem {
    public static final Creator<C1158m> CREATOR = new C0542n();
    private byte[] TF;
    private final Map<String, DataItemAsset> alK;
    private final Uri mUri;
    final int xM;

    C1158m(int i, Uri uri, Bundle bundle, byte[] bArr) {
        this.xM = i;
        this.mUri = uri;
    ...
    public C1158m m3902m(byte[] bArr) {
        this.TF = bArr;
        return this;
    }
