...
public interface as extends IInterface {
    ...
    public static abstract class C0678a extends Binder implements as {

        private static class C0677a implements as {
            private IBinder kq;
        ...
        public static as m2469h(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof as)) ? new C0677a(iBinder) : (as) queryLocalInterface;
        }
