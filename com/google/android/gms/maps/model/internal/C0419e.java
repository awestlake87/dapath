...
public interface C0419e extends IInterface {

    public static abstract class C0887a extends Binder implements C0419e {

        private static class C0886a implements C0419e {
            private IBinder kq;
            ...
            public boolean mo2187a(C0419e c0419e) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IIndoorLevelDelegate");
                    obtain.writeStrongBinder(c0419e != null ? c0419e.asBinder() : null);
        ...
        public static C0419e bb(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IIndoorLevelDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0419e)) ? new C0886a(iBinder) : (C0419e) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorLevelDelegate");
                    boolean a = mo2187a(C0887a.bb(data.readStrongBinder()));
                    reply.writeNoException();
    ...
    boolean mo2187a(C0419e c0419e) throws RemoteException;
