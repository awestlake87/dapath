...
public final class Games {
    ...
    static final C0149c<GamesClientImpl> yH = new C0149c();
    private static final C0148b<GamesClientImpl, GamesOptions> yI = new C06621();

    static class C06621 implements C0148b<GamesClientImpl, GamesOptions> {
        C06621() {
        }
    ...
    public static abstract class BaseGamesApiMethodImpl<R extends Result> extends C1002b<R, GamesClientImpl> {
    ...
    static class C13122 extends SignOutImpl {
        C13122() {
            super();
        }

        protected void m4408a(GamesClientImpl gamesClientImpl) {
            gamesClientImpl.m3387b((C0152d) this);
        }
    }
    ...
    public static GamesClientImpl m473d(GoogleApiClient googleApiClient) {
        GamesClientImpl gamesClientImpl = (GamesClientImpl) googleApiClient.mo925a(yH);
    ...
    public static PendingResult<Status> signOut(GoogleApiClient apiClient) {
        return apiClient.mo927b(new C13122());
    }
}
