...
public interface IGamesSignInCallbacks extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGamesSignInCallbacks {
        ...
        private static class Proxy implements IGamesSignInCallbacks {
            ...
            public void mo1385S(DataHolder dataHolder) throws RemoteException {
            ...
            public void mo1386T(DataHolder dataHolder) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.games.internal.IGamesSignInCallbacks");
            ...
            public void mo1387b(int i, Intent intent) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.games.internal.IGamesSignInCallbacks");
            ...
            public void mo1390g(DataHolder dataHolder) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.games.internal.IGamesSignInCallbacks");
    ...
    void mo1385S(DataHolder dataHolder) throws RemoteException;

    void mo1386T(DataHolder dataHolder) throws RemoteException;

    void mo1387b(int i, Intent intent) throws RemoteException;

    void ci(int i) throws RemoteException;

    void cj(int i) throws RemoteException;

    void mo1390g(DataHolder dataHolder) throws RemoteException;
}
