...
public final class AdSize {
    ...
    public int getHeightInPixels(Context context) {
        return this.kv == -2 ? al.m2455b(context.getResources().getDisplayMetrics()) : et.m1004a(context, this.kv);
    }
    ...
    public int getWidthInPixels(Context context) {
        return this.ku == -1 ? al.m2454a(context.getResources().getDisplayMetrics()) : et.m1004a(context, this.ku);
    }
