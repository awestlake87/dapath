...
public interface jy extends IInterface {
    ...
    public static abstract class C0776a extends Binder implements jy {

        private static class C0775a implements jy {
            private IBinder kq;
            ...
            public void mo1853V(DataHolder dataHolder) throws RemoteException {
            ...
            public void mo1854W(DataHolder dataHolder) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.location.places.internal.IPlacesCallbacks");
                    if (dataHolder != null) {
            ...
            public void mo1855X(DataHolder dataHolder) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.location.places.internal.IPlacesCallbacks");
                    if (dataHolder != null) {
        ...
        public static jy au(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof jy)) ? new C0775a(iBinder) : (jy) queryLocalInterface;
        }
    ...
    void mo1853V(DataHolder dataHolder) throws RemoteException;

    void mo1854W(DataHolder dataHolder) throws RemoteException;

    void mo1855X(DataHolder dataHolder) throws RemoteException;
}
