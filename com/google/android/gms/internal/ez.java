...
public class ez extends WebChromeClient {
    ...
    private static void m1046a(Builder builder, String str, final JsResult jsResult) {
    ...
    private static void m1047a(Context context, Builder builder, String str, String str2, final JsPromptResult jsPromptResult) {
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        switch (C03257.sS[consoleMessage.messageLevel().ordinal()]) {
            case 1:
                eu.m1011A(str);
                break;
            case 2:
