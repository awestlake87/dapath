...
class GameHelperUtils {
    ...
    private static final int[] RES_IDS = new int[]{C0099R.string.gamehelper_unknown_error, C0099R.string.gamehelper_sign_in_failed, C0099R.string.gamehelper_app_misconfigured, C0099R.string.gamehelper_license_failed};
