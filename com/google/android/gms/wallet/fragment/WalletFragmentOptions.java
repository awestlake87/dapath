...
public final class WalletFragmentOptions implements SafeParcelable {
    public static final Creator<WalletFragmentOptions> CREATOR = new C0508b();
    private int Hy;
    ...
    public static WalletFragmentOptions m3111a(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0100R.styleable.WalletFragmentOptions);
