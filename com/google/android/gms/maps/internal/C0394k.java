...
public interface C0394k extends IInterface {

    public static abstract class C0858a extends Binder implements C0394k {

        private static class C0857a implements C0394k {
            private IBinder kq;
        ...
        public static C0394k aJ(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapLongClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0394k)) ? new C0857a(iBinder) : (C0394k) queryLocalInterface;
        }
