...
public final class Marker {
    private final C0420f aaO;

    public Marker(C0420f delegate) {
        this.aaO = (C0420f) hm.m1232f(delegate);
    }
    ...
    public boolean equals(Object other) {
        ...
        try {
            return this.aaO.mo2198h(((Marker) other).aaO);
