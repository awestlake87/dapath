...
public class MenuPopupHelper implements OnItemClickListener, OnKeyListener, OnGlobalLayoutListener, OnDismissListener, MenuPresenter {
    static final int ITEM_LAYOUT = C0067R.layout.abc_popup_menu_item_layout;
    ...
    public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView, boolean overflowOnly) {
        ...
        this.mPopupMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0067R.dimen.abc_config_prefDialogWidth));
    ...
    public boolean tryShow() {
        ...
        this.mPopup = new ListPopupWindow(this.mContext, null, C0067R.attr.popupMenuStyle);
