...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C00631();
    ...
    private final Runnable mSetIdleRunnable = new C00642();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    static class C00631 implements Interpolator {
        C00631() {
        }
