...
public class ActionBarView extends AbsActionBarView {
    ...
    private final OnClickListener mExpandedActionViewUpListener = new C00742();
    ...
    private final OnItemSelectedListener mNavItemSelectedListener = new C05721();
    ...
    private final OnClickListener mUpClickListener = new C00753();
    ...
    private static class HomeView extends FrameLayout {
        ...
        protected void onFinishInflate() {
            this.mUpView = (ImageView) findViewById(C0067R.id.up);
            this.mIconView = (ImageView) findViewById(C0067R.id.home);
    ...
    class C05721 implements OnItemSelectedListener {
        C05721() {
        }
    ...
    public ActionBarView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0067R.styleable.ActionBar, C0067R.attr.actionBarStyle, 0);
        ...
        int homeResId = a.getResourceId(14, C0067R.layout.abc_action_bar_home);
        ...
        this.mExpandedHomeLayout.setContentDescription(getResources().getText(C0067R.string.abc_action_bar_up_description));
    ...
    public void initProgress() {
        ...
        this.mProgressView.setId(C0067R.id.progress_horizontal);
    ...
    public void initIndeterminateProgress() {
        ...
        this.mIndeterminateProgressView.setId(C0067R.id.progress_circular);
        ...
        if (this.mSplitActionBar != splitActionBar) {
            ...
            if (this.mActionMenuPresenter != null) {
                if (splitActionBar) {
                    ...
                    this.mActionMenuPresenter.setExpandedActionViewsExclusive(getResources().getBoolean(C0067R.bool.abc_action_bar_expanded_action_views_exclusive));
                }
            }
    ...
    public void setMenu(SupportMenu menu, MenuPresenter.Callback cb) {
        if (menu != this.mOptionsMenu) {
            ...
            if (this.mActionMenuPresenter == null) {
                ...
                this.mActionMenuPresenter.setId(C0067R.id.action_menu_presenter);
    ...
    public void setHomeButtonEnabled(boolean enable) {
        ...
        if (!enable) {
            ...
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0067R.string.abc_action_bar_up_description));
        } else {
            this.mHomeLayout.setContentDescription(this.mContext.getResources().getText(C0067R.string.abc_action_bar_home_description));
        }
    }
            ...
            switch (mode) {
                case 1:
                    if (this.mSpinner == null) {
                        this.mSpinner = new SpinnerICS(this.mContext, null, C0067R.attr.actionDropDownStyle);
                        this.mListNavLayout = (LinearLayout) LayoutInflater.from(this.mContext).inflate(C0067R.layout.abc_action_bar_view_list_nav_layout, null);
    ...
    private void initTitle() {
        ...
        if (this.mTitleLayout == null) {
            boolean homeAsUp;
            boolean showHome;
            this.mTitleLayout = (LinearLayout) LayoutInflater.from(getContext()).inflate(C0067R.layout.abc_action_bar_title_item, this, false);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0067R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0067R.id.action_bar_subtitle);
            this.mTitleUpView = this.mTitleLayout.findViewById(C0067R.id.up);
