...
public abstract class C1006g<T> extends DataBuffer<T> {
    private boolean EU = false;
    private ArrayList<Integer> EV;

    protected C1006g(DataHolder dataHolder) {
        super(dataHolder);
    }
    ...
    protected abstract T mo3142c(int i, int i2);
    ...
    public final T get(int position) {
        fa();
        return mo3142c(ah(position), ai(position));
    }
