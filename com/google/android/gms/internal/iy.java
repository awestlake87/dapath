...
public interface iy extends IInterface {
    ...
    public static abstract class C0764a extends Binder implements iy {

        private static class C0763a implements iy {
            private IBinder kq;
            ...
            public void mo1798a(ix ixVar, UserAddressRequest userAddressRequest, Bundle bundle) throws RemoteException {
        ...
        public static iy ap(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof iy)) ? new C0763a(iBinder) : (iy) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 2:
                    ...
                    mo1798a(C0762a.ao(data.readStrongBinder()), data.readInt() != 0 ? (UserAddressRequest) UserAddressRequest.CREATOR.createFromParcel(data) : null, data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
    ...
    void mo1798a(ix ixVar, UserAddressRequest userAddressRequest, Bundle bundle) throws RemoteException;
}
