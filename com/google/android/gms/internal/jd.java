...
public interface jd extends IInterface {
    ...
    public static abstract class C0769a extends Binder implements jd {

        private static class C0768a implements jd {
            private IBinder kq;
        ...
        public static jd ar(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof jd)) ? new C0768a(iBinder) : (jd) queryLocalInterface;
        }
