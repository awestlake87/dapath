...
public interface bv extends IInterface {
    ...
    public static abstract class C0692a extends Binder implements bv {

        private static class C0691a implements bv {
            private IBinder kq;
        ...
        public static bv m2505k(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof bv)) ? new C0691a(iBinder) : (bv) queryLocalInterface;
        }
