...
public interface C0401r extends IInterface {

    public static abstract class C0872a extends Binder implements C0401r {

        private static class C0871a implements C0401r {
            private IBinder kq;
        ...
        public static C0401r aQ(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0401r)) ? new C0871a(iBinder) : (C0401r) queryLocalInterface;
        }
