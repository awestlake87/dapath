...
import com.google.android.gms.internal.hk.C0352a;
import com.google.android.gms.plus.PlusShare;

public final class AchievementRef extends C0160d implements Achievement {
    ...
    public String toString() {
        C0352a a = hk.m1221e(this).m1220a("AchievementId", getAchievementId()).m1220a("Type", Integer.valueOf(getType())).m1220a("Name", getName()).m1220a("Description", getDescription()).m1220a("UnlockedImageUri", getUnlockedImageUri()).m1220a("UnlockedImageUrl", getUnlockedImageUrl()).m1220a("RevealedImageUri", getRevealedImageUri()).m1220a("RevealedImageUrl", getRevealedImageUrl()).m1220a("Player", getPlayer()).m1220a("LastUpdatedTimeStamp", Long.valueOf(getLastUpdatedTimestamp()));
        if (getType() == 1) {
