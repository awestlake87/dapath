...
public final class gt extends Drawable implements Callback {
    ...
    private static final class C0340a extends Drawable {
        private static final C0340a FK = new C0340a();
        private static final C0339a FL = new C0339a();

        private static final class C0339a extends ConstantState {
            private C0339a() {
            }
    ...
    static final class C0341b extends ConstantState {
        int FM;
        int FN;

        C0341b(C0341b c0341b) {
            if (c0341b != null) {
                this.FM = c0341b.FM;
                this.FN = c0341b.FN;
            }
    ...
    public gt(Drawable drawable, Drawable drawable2) {
        ...
        C0341b c0341b = this.FD;
        c0341b.FN |= drawable.getChangingConfigurations();
        if (drawable2 == null) {
            drawable2 = C0340a.FK;
        }
        this.FF = drawable2;
        ...
        c0341b = this.FD;
        c0341b.FN |= drawable2.getChangingConfigurations();
    }
