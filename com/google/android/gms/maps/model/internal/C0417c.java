...
public interface C0417c extends IInterface {

    public static abstract class C0883a extends Binder implements C0417c {

        private static class C0882a implements C0417c {
            private IBinder kq;
            ...
            public void mo2160a(float f, float f2) throws RemoteException {
            ...
            public boolean mo2161a(C0417c c0417c) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    obtain.writeStrongBinder(c0417c != null ? c0417c.asBinder() : null);
            ...
            public void mo2172l(C0252d c0252d) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
        ...
        public static C0417c aZ(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0417c)) ? new C0882a(iBinder) : (C0417c) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 6:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    mo2160a(data.readFloat(), data.readFloat());
                    reply.writeNoException();
                    return true;
                case 7:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                ...
                case TimeUtils.HUNDRED_DAY_FIELD_LEN /*19*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    isVisible = mo2161a(C0883a.aZ(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
                ...
                case 21:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IGroundOverlayDelegate");
                    mo2172l(C0661a.ag(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void mo2160a(float f, float f2) throws RemoteException;

    boolean mo2161a(C0417c c0417c) throws RemoteException;
    ...
    void mo2172l(C0252d c0252d) throws RemoteException;
