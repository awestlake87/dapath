...
import com.dapath.gamemodes.Game;
...
public class Main extends BaseGameActivity implements OnClickListener, DaPathFragmentListener {
    ...
    public class AdFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            this.container = inflater.inflate(C0099R.layout.fragment_ad, container, false);
            return this.container;
        }

        public void onActivityCreated(Bundle bundle) {
            super.onActivityCreated(bundle);
            this.adView = (AdView) getView().findViewById(C0099R.id.adView);
            this.adView.loadAd(new Builder().addTestDevice(getString(C0099R.string.ad_test_device)).build());
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        foreground = getResources().getColor(C0099R.color.foreground);
        background = getResources().getColor(C0099R.color.background);
        darkforeground = getResources().getColor(C0099R.color.selected);
        this.gameFrame = (FrameLayout) ((LayoutInflater) getSystemService("layout_inflater")).inflate(C0099R.layout.game_frame, null);
    ...
    public void setGame(String name, ModeProfile profile, Handler handler) {
        this.surface.game = new Game(name, profile, handler);
    }
