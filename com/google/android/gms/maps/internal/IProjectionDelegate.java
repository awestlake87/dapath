...
public interface IProjectionDelegate extends IInterface {
    ...
    public static abstract class C0830a extends Binder implements IProjectionDelegate {

        private static class C0829a implements IProjectionDelegate {
            private IBinder kq;
            ...
            public LatLng fromScreenLocation(C0252d point) throws RemoteException {
                LatLng latLng = null;
            ...
            public C0252d toScreenLocation(LatLng location) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IProjectionDelegate");
        ...
        public static IProjectionDelegate aR(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IProjectionDelegate)) ? new C0829a(iBinder) : (IProjectionDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    LatLng fromScreenLocation = fromScreenLocation(C0661a.ag(data.readStrongBinder()));
                ...
                case 2:
                    data.enforceInterface("com.google.android.gms.maps.internal.IProjectionDelegate");
                    C0252d toScreenLocation = toScreenLocation(data.readInt() != 0 ? LatLng.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
    ...
    LatLng fromScreenLocation(C0252d c0252d) throws RemoteException;

    VisibleRegion getVisibleRegion() throws RemoteException;

    C0252d toScreenLocation(LatLng latLng) throws RemoteException;
}
