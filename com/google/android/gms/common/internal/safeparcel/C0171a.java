...
public class C0171a {
    ...
    public static class C0170a extends RuntimeException {
        public C0170a(String str, Parcel parcel) {
    ...
    public static int m196B(Parcel parcel) {
        ...
        int a = C0171a.m200a(parcel, A);
        int dataPosition = parcel.dataPosition();
        if (C0171a.ar(A) != 20293) {
            throw new C0170a("Expected object header. Got 0x" + Integer.toHexString(A), parcel);
        }
        A = dataPosition + a;
        if (A >= dataPosition && A <= parcel.dataSize()) {
            return A;
        }
        throw new C0170a("Size read is invalid start=" + dataPosition + " end=" + A, parcel);
    }
    ...
    private static void m202a(Parcel parcel, int i, int i2) {
        int a = C0171a.m200a(parcel, i);
        if (a != i2) {
            throw new C0170a("Expected size " + i2 + " got " + a + " (0x" + Integer.toHexString(a) + ")", parcel);
        }
    }

    private static void m203a(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
            throw new C0170a("Expected size " + i3 + " got " + i2 + " (0x" + Integer.toHexString(i2) + ")", parcel);
        }
    }
    ...
    public static void m205b(Parcel parcel, int i) {
        parcel.setDataPosition(C0171a.m200a(parcel, i) + parcel.dataPosition());
    }
