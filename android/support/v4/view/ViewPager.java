...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C00411();
    ...
    private static final Interpolator sInterpolator = new C00422();
    ...
    private final Runnable mEndScrollRunnable = new C00433();
    ...
    static class C00411 implements Comparator<ItemInfo> {
        C00411() {
        }
    ...
    static class C00422 implements Interpolator {
        C00422() {
        }
    ...
    public static class SavedState extends BaseSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C05591());
