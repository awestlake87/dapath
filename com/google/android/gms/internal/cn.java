...
public interface cn extends IInterface {
    ...
    public static abstract class C0695a extends Binder implements cn {

        private static class C0694a implements cn {
            private IBinder kq;
            ...
            public void mo1655S() throws RemoteException {
        ...
        public static cn m2516m(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof cn)) ? new C0694a(iBinder) : (cn) queryLocalInterface;
        }
    ...
    void mo1655S() throws RemoteException;
