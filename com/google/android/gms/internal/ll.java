...
public interface ll extends IInterface {
    ...
    public static abstract class C0784a extends Binder implements ll {

        private static class C0783a implements ll {
            private IBinder kq;

            C0783a(IBinder iBinder) {
                this.kq = iBinder;
            }

            public void mo1887a(int i, int i2, Bundle bundle) throws RemoteException {
        ...
        public static ll bp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ll)) ? new C0783a(iBinder) : (ll) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 2:
                    ...
                    mo1887a(data.readInt(), data.readInt(), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null);
    ...
    void mo1887a(int i, int i2, Bundle bundle) throws RemoteException;
}
