...
public interface C0418d extends IInterface {

    public static abstract class C0885a extends Binder implements C0418d {

        private static class C0884a implements C0418d {
            private IBinder kq;
            ...
            public boolean mo2181b(C0418d c0418d) throws RemoteException {
                boolean z = false;
        ...
        public static C0418d ba(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0418d)) ? new C0884a(iBinder) : (C0418d) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IIndoorBuildingDelegate");
                    isUnderground = mo2181b(C0885a.ba(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isUnderground) {
                        i = 1;
                    }
    ...
    boolean mo2181b(C0418d c0418d) throws RemoteException;
