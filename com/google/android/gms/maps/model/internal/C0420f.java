...
public interface C0420f extends IInterface {

    public static abstract class C0889a extends Binder implements C0420f {

        private static class C0888a implements C0420f {
            private IBinder kq;
            ...
            public boolean mo2198h(C0420f c0420f) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
            ...
            public void mo2205m(C0252d c0252d) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IMarkerDelegate");
        ...
        public static C0420f bc(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0420f)) ? new C0888a(iBinder) : (C0420f) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 16:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    isDraggable = mo2198h(C0889a.bc(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isDraggable) {
                        i = 1;
                    }
                ...
                case 18:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    mo2205m(C0661a.ag(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
    ...
    boolean mo2198h(C0420f c0420f) throws RemoteException;
    ...
    void mo2205m(C0252d c0252d) throws RemoteException;
