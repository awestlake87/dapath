...
public interface IPolylineDelegate extends IInterface {
    ...
    public static abstract class C0877a extends Binder implements IPolylineDelegate {

        private static class C0876a implements IPolylineDelegate {
            private IBinder kq;
        ...
        public static IPolylineDelegate be(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IPolylineDelegate)) ? new C0876a(iBinder) : (IPolylineDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 15:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    isVisible = equalsRemote(C0877a.be(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
