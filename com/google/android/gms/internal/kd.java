...
public interface kd extends IInterface {
    ...
    public static abstract class C0778a extends Binder implements kd {

        private static class C0777a implements kd {
            private IBinder kq;
        ...
        public static kd bh(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof kd)) ? new C0777a(iBinder) : (kd) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    mo1856a(data.readInt(), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt(), data.readInt() != 0 ? (Intent) Intent.CREATOR.createFromParcel(data) : null);
    ...
    void mo1856a(int i, Bundle bundle, int i2, Intent intent) throws RemoteException;
}
