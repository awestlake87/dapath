...
import android.support.v7.appcompat.C0067R;
...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    class C00914 implements OnFocusChangeListener {
        C00914() {
        }
    ...
    class C00925 implements OnLayoutChangeListener {
        C00925() {
        }
    ...
    class C00936 implements OnGlobalLayoutListener {
        C00936() {
        }
    ...
    class C00958 implements OnKeyListener {
        C00958() {
        }
    ...
    class C00969 implements OnEditorActionListener {
        C00969() {
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mShowImeRunnable = new C00881();
        this.mUpdateDrawableStateRunnable = new C00892();
        this.mReleaseCursorRunnable = new C00903();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C00947();
        this.mTextKeyListener = new C00958();
        this.mOnEditorActionListener = new C00969();
        ...
        ((LayoutInflater) context.getSystemService("layout_inflater")).inflate(C0067R.layout.abc_search_view, this, true);
        this.mSearchButton = findViewById(C0067R.id.search_button);
        this.mQueryTextView = (SearchAutoComplete) findViewById(C0067R.id.search_src_text);
        this.mQueryTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0067R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0067R.id.search_plate);
        this.mSubmitArea = findViewById(C0067R.id.submit_area);
        this.mSubmitButton = findViewById(C0067R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0067R.id.search_close_btn);
        this.mVoiceButton = findViewById(C0067R.id.search_voice_btn);
        this.mSearchHintIcon = (ImageView) findViewById(C0067R.id.search_mag_icon);
        ...
        this.mQueryTextView.setOnFocusChangeListener(new C00914());
        TypedArray a = context.obtainStyledAttributes(attrs, C0067R.styleable.SearchView, 0, 0);
        ...
        a.recycle();
        a = context.obtainStyledAttributes(attrs, C0067R.styleable.View, 0, 0);
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C00925());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C00936());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0067R.dimen.abc_search_view_preferred_width);
    }
    ...
    private void updateViewsVisibility(boolean collapsed) {
        ...
        boolean hasText = !TextUtils.isEmpty(this.mQueryTextView.getText()) ? true : DBG;
    ...
    private int getSearchIconId() {
        ...
        getContext().getTheme().resolveAttribute(C0067R.attr.searchViewSearchIcon, outValue, true);
    ...
    private void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0067R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0067R.dimen.abc_dropdownitem_text_padding_left) : 0;
