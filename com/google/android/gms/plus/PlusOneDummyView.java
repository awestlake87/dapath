...
public class PlusOneDummyView extends FrameLayout {
    ...
    private static class C0905a implements C0427d {
        private Context mContext;

        private C0905a(Context context) {
    ...
    private static class C0906b implements C0427d {
        private Context mContext;

        private C0906b(Context context) {
            this.mContext = context;
        }
    ...
    private static class C0907c implements C0427d {
        private Context mContext;
    ...
    private C0427d jT() {
        C0427d c0906b = new C0906b(getContext());
        if (!c0906b.isValid()) {
            c0906b = new C0907c(getContext());
        }
        return !c0906b.isValid() ? new C0905a(getContext()) : c0906b;
    }
}
