...
public abstract class BaseGameActivity extends FragmentActivity implements GameHelperListener {
    ...
    protected SharedPreferences GPPrefs;
    ...
    public GameHelper getGameHelper() {
        if (this.mHelper == null) {
            ...
            this.GPPrefs = getSharedPreferences("GP_PREFS", 0);
            this.mHelper.setConnectOnStart(this.GPPrefs.getBoolean("LAST_SIGNED_IN", false));
        }
        return this.mHelper;
    }
