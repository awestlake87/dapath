...
public interface dd extends IInterface {
    ...
    public static abstract class C0703a extends Binder implements dd {

        private static class C0702a implements dd {
            private IBinder kq;
        ...
        public static dd m2530r(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof dd)) ? new C0702a(iBinder) : (dd) queryLocalInterface;
        }
