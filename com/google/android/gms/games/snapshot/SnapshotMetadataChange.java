...
public final class SnapshotMetadataChange implements SafeParcelable {
    ...
    SnapshotMetadataChange(int versionCode, String description, Long playedTimeMillis, C0609a coverImage, Uri coverImageUri) {
        boolean z = true;
        this.xM = versionCode;
        this.Mp = description;
    ...
    SnapshotMetadataChange(String description, Long playedTimeMillis, C0609a coverImage, Uri coverImageUri) {
