...
import com.google.android.gms.maps.internal.C0399p.C0868a;
import com.google.android.gms.maps.internal.C0400q.C0870a;
import com.google.android.gms.maps.internal.C0401r.C0872a;
...
public interface IStreetViewPanoramaDelegate extends IInterface {
    ...
    public static abstract class C0832a extends Binder implements IStreetViewPanoramaDelegate {

        private static class C0831a implements IStreetViewPanoramaDelegate {
            private IBinder kq;
            ...
            public C0252d orientationToPoint(StreetViewPanoramaOrientation orientation) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            ...
            public StreetViewPanoramaOrientation pointToOrientation(C0252d point) throws RemoteException {
            ...
            public void setOnStreetViewPanoramaCameraChangeListener(C0399p listener) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            ...
            public void setOnStreetViewPanoramaChangeListener(C0400q listener) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
            ...
            public void setOnStreetViewPanoramaClickListener(C0401r listener) throws RemoteException {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
        ...
        public static IStreetViewPanoramaDelegate aT(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IStreetViewPanoramaDelegate)) ? new C0831a(iBinder) : (IStreetViewPanoramaDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 15:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    setOnStreetViewPanoramaChangeListener(C0870a.aP(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 16:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    setOnStreetViewPanoramaCameraChangeListener(C0868a.aO(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 17:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    setOnStreetViewPanoramaClickListener(C0872a.aQ(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 18:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    StreetViewPanoramaOrientation pointToOrientation = pointToOrientation(C0661a.ag(data.readStrongBinder()));
                    reply.writeNoException();
                ...
                case TimeUtils.HUNDRED_DAY_FIELD_LEN /*19*/:
                    data.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaDelegate");
                    C0252d orientationToPoint = orientationToPoint(data.readInt() != 0 ? StreetViewPanoramaOrientation.CREATOR.createFromParcel(data) : null);
                    reply.writeNoException();
    ...
    C0252d orientationToPoint(StreetViewPanoramaOrientation streetViewPanoramaOrientation) throws RemoteException;

    StreetViewPanoramaOrientation pointToOrientation(C0252d c0252d) throws RemoteException;

    void setOnStreetViewPanoramaCameraChangeListener(C0399p c0399p) throws RemoteException;

    void setOnStreetViewPanoramaChangeListener(C0400q c0400q) throws RemoteException;

    void setOnStreetViewPanoramaClickListener(C0401r c0401r) throws RemoteException;
