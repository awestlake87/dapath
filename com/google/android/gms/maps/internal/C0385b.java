...
public interface C0385b extends IInterface {

    public static abstract class C0840a extends Binder implements C0385b {

        private static class C0839a implements C0385b {
            private IBinder kq;
        ...
        public static C0385b aw(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ICancelableCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0385b)) ? new C0839a(iBinder) : (C0385b) queryLocalInterface;
        }
