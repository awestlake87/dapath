...
public final class GooglePlayServicesUtil {
    ...
    private static final byte[][] Dd = m131a(CV, CW, CX, CY, CZ, Da, Db, Dc);
    ...
    private static String m125B(Context context) {
    ...
    public static Intent m126Z(int i) {
        switch (i) {
            case 1:
            case 2:
    ...
    private static Dialog m127a(int i, Activity activity, Fragment fragment, int i2, OnCancelListener onCancelListener) {
        Builder builder;
        Intent c;
        ...
        if (ip.gf()) {
            ...
            if ("Theme.Dialog.Alert".equals(activity.getResources().getResourceEntryName(typedValue.resourceId))) {
                ...
                builder.setMessage(m138d(activity, i));
                ...
                switch (i) {
                    case 0:
                        return null;
                    case 1:
                        return builder.setTitle(C0100R.string.common_google_play_services_install_title).create();
                    case 2:
                        return builder.setTitle(C0100R.string.common_google_play_services_update_title).create();
                    case 3:
                        return builder.setTitle(C0100R.string.common_google_play_services_enable_title).create();
                    case 4:
                    case 6:
                        return builder.create();
                    case 5:
                        Log.e("GooglePlayServicesUtil", "An invalid account was specified when connecting. Please provide a valid account.");
                        return builder.setTitle(C0100R.string.common_google_play_services_invalid_account_title).create();
                    case 7:
                        Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
                        return builder.setTitle(C0100R.string.common_google_play_services_network_error_title).create();
                    case 8:
                        Log.e("GooglePlayServicesUtil", "Internal error occurred. Please see logs for detailed information");
                        return builder.create();
                    case 9:
                        Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
                        return builder.setTitle(C0100R.string.common_google_play_services_unsupported_title).create();
                    case 10:
    ...
    public static boolean m128a(PackageManager packageManager, PackageInfo packageInfo) {
        boolean z = true;
        boolean z2 = false;
        if (packageInfo == null) {
            return false;
        }
        if (m137c(packageManager)) {
            if (m130a(packageInfo, Dd) == null) {
                z = false;
            }
            return z;
        }
        if (m130a(packageInfo, De) != null) {
            z2 = true;
        }
        if (z2 || m130a(packageInfo, Dd) == null) {
            return z2;
        }
    ...
    public static boolean m129a(Resources resources) {
        if (resources == null) {
            return false;
        }
        return (ip.gc() && ((resources.getConfiguration().screenLayout & 15) > 3)) || m135b(resources);
    }

    private static byte[] m130a(PackageInfo packageInfo, byte[]... bArr) {
        try {
    ...
    private static byte[][] m131a(byte[][]... bArr) {
        int i = 0;
    ...
    public static boolean m132b(int i, Activity activity, Fragment fragment, int i2, OnCancelListener onCancelListener) {
        boolean z = false;
        Dialog a = m127a(i, activity, fragment, i2, onCancelListener);
        if (a == null) {
            return z;
        }
        try {
    ...
    public static boolean m133b(PackageManager packageManager) {
        synchronized (Di) {
            if (Dh == -1) {
                try {
                    if (m130a(packageManager.getPackageInfo(GOOGLE_PLAY_SERVICES_PACKAGE, 64), Dd[1]) != null) {
                        Dh = 1;
                    } else {
                        Dh = 0;
                    }
    ...
    public static boolean m134b(PackageManager packageManager, String str) {
        try {
            return m128a(packageManager, packageManager.getPackageInfo(str, 64));
        } catch (NameNotFoundException e) {
    ...
    private static boolean m135b(Resources resources) {
        Configuration configuration = resources.getConfiguration();
        return ip.ge() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= 600;
    }

    @Deprecated
    public static Intent m136c(Context context, int i) {
        return m126Z(i);
    }

    public static boolean m137c(PackageManager packageManager) {
        return m133b(packageManager) || !ey();
    }

    public static String m138d(Context context, int i) {
        Resources resources = context.getResources();
        switch (i) {
            case 1:
                return m129a(context.getResources()) ? resources.getString(C0100R.string.common_google_play_services_install_text_tablet) : resources.getString(C0100R.string.common_google_play_services_install_text_phone);
            case 2:
                return resources.getString(C0100R.string.common_google_play_services_update_text);
            case 3:
                return resources.getString(C0100R.string.common_google_play_services_enable_text);
            case 5:
                return resources.getString(C0100R.string.common_google_play_services_invalid_account_text);
            case 7:
                return resources.getString(C0100R.string.common_google_play_services_network_error_text);
            case 9:
                return resources.getString(C0100R.string.common_google_play_services_unsupported_text);
            case 12:
                return resources.getString(C0100R.string.common_google_play_services_unsupported_date_text);
            default:
                return resources.getString(C0100R.string.common_google_play_services_unknown_issue);
        }
    }

    public static String m139e(Context context, int i) {
        Resources resources = context.getResources();
        switch (i) {
            case 1:
                return resources.getString(C0100R.string.common_google_play_services_install_button);
            case 2:
                return resources.getString(C0100R.string.common_google_play_services_update_button);
            case 3:
                return resources.getString(C0100R.string.common_google_play_services_enable_button);
            default:
    ...
    public static String m140f(Context context, int i) {
        Resources resources = context.getResources();
        switch (i) {
            case 1:
                return resources.getString(C0100R.string.f11x8f024ee1);
            case 2:
                return resources.getString(C0100R.string.common_google_play_services_notification_needs_update_title);
            case 3:
                return resources.getString(C0100R.string.common_google_play_services_needs_enabling_title);
            case 5:
                return resources.getString(C0100R.string.common_google_play_services_invalid_account_text);
            case 7:
                return resources.getString(C0100R.string.common_google_play_services_network_error_text);
    ...
    public static Dialog getErrorDialog(int errorCode, Activity activity, int requestCode, OnCancelListener cancelListener) {
        return m127a(errorCode, activity, null, requestCode, cancelListener);
    }

    public static PendingIntent getErrorPendingIntent(int errorCode, Context context, int requestCode) {
        Intent c = m136c(context, errorCode);
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            ...
            } else if (!ii.m1273F(context)) {
                try {
                    if (m130a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 64), CV) == null) {
                        Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                        return 9;
                    }
                    if (m130a(packageInfo, m130a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 64), CV)) == null) {
            ...
            } else if (m130a(packageInfo, CV) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                return 9;
            }
    ...
    public static boolean showErrorDialogFragment(int errorCode, Activity activity, int requestCode, OnCancelListener cancelListener) {
        return m132b(errorCode, activity, null, requestCode, cancelListener);
    }

    public static void showErrorNotification(int errorCode, Context context) {
        Resources resources = context.getResources();
        Notification notification = new Notification(17301642, resources.getString(C0100R.string.common_google_play_services_notification_ticker), System.currentTimeMillis());
        notification.flags |= 16;
        CharSequence f = m140f(context, errorCode);
        String B = m125B(context);
        notification.setLatestEventInfo(context, f, resources.getString(C0100R.string.common_google_play_services_error_notification_requested_by_msg, new Object[]{B}), getErrorPendingIntent(errorCode, context, 0));
        ((NotificationManager) context.getSystemService("notification")).notify(39789, notification);
    }

    public static void m141z(Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        int isGooglePlayServicesAvailable = isGooglePlayServicesAvailable(context);
        if (isGooglePlayServicesAvailable != 0) {
            Intent c = m136c(context, isGooglePlayServicesAvailable);
