...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    class C00591 extends Animation {
        C00591() {
        }
    ...
    class C00602 extends Animation {
        C00602() {
        }
    ...
    class C00626 implements Runnable {
        C00626() {
        }
    ...
    class C05683 extends BaseAnimationListener {
        C05683() {
            super();
        }
    ...
    class C05694 extends BaseAnimationListener {
        C05694() {
            super();
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mAnimateToStartPosition = new C00591();
        this.mShrinkTrigger = new C00602();
        this.mReturnToStartPositionListener = new C05683();
        this.mShrinkAnimationListener = new C05694();
        this.mReturnToStartPosition = new C00615();
        this.mCancel = new C00626();
    ...
    private void ensureTarget() {
        ...
        if (this.mDistanceToTriggerSync == GroundOverlayOptions.NO_DIMENSION && getParent() != null && ((View) getParent()).getHeight() > 0) {
            this.mDistanceToTriggerSync = (float) ((int) Math.min(((float) ((View) getParent()).getHeight()) * 0.6f, BitmapDescriptorFactory.HUE_GREEN * getResources().getDisplayMetrics().density));
        }
    }
