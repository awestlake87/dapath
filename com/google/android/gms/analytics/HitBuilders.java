...
public class HitBuilders {
    ...
    protected static class HitBuilder<T extends HitBuilder> {
        ...
        public Map<String, String> build() {
            ...
            for (Promotion X : this.wC) {
                hashMap.putAll(X.m61X(C0122o.m75v(i)));
                i++;
            }
            i = 1;
            for (Product X2 : this.wD) {
                hashMap.putAll(X2.m60X(C0122o.m74u(i)));
                i++;
            }
            int i2 = 1;
            for (Entry entry : this.wB.entrySet()) {
                List<Product> list = (List) entry.getValue();
                String x = C0122o.m77x(i2);
                int i3 = 1;
                for (Product X3 : list) {
                    hashMap.putAll(X3.m60X(x + C0122o.m76w(i3)));
                    i3++;
                }
        ...
        public final T set(String paramName, String paramValue) {
            C0138u.cU().m83a(C0137a.MAP_BUILDER_SET);
            if (paramName != null) {
        ...
        public final T setAll(Map<String, String> params) {
            C0138u.cU().m83a(C0137a.MAP_BUILDER_SET_ALL);
            if (params != null) {
        ...
        public T setCampaignParamsFromUrl(String utmParams) {
            C0138u.cU().m83a(C0137a.MAP_BUILDER_SET_CAMPAIGN_PARAMS);
        ...
        public T setCustomDimension(int index, String dimension) {
            set(C0122o.m72s(index), dimension);
            return this;
        }

        public T setCustomMetric(int index, float metric) {
            set(C0122o.m73t(index), Float.toString(metric));
            return this;
        }
    ...
    public static class AppViewBuilder extends HitBuilder<AppViewBuilder> {
        public AppViewBuilder() {
            C0138u.cU().m83a(C0137a.CONSTRUCT_APP_VIEW);
            set("&t", "screenview");
        }
    ...
    public static class EventBuilder extends HitBuilder<EventBuilder> {
        public EventBuilder() {
            C0138u.cU().m83a(C0137a.CONSTRUCT_EVENT);
    ...
    public static class ExceptionBuilder extends HitBuilder<ExceptionBuilder> {
        public ExceptionBuilder() {
            C0138u.cU().m83a(C0137a.CONSTRUCT_EXCEPTION);
            set("&t", "exception");
        }
    ...
    public static class ItemBuilder extends HitBuilder<ItemBuilder> {
        public ItemBuilder() {
            C0138u.cU().m83a(C0137a.CONSTRUCT_ITEM);
            set("&t", "item");
        }
    ...
    public static class SocialBuilder extends HitBuilder<SocialBuilder> {
        public SocialBuilder() {
            C0138u.cU().m83a(C0137a.CONSTRUCT_SOCIAL);
            set("&t", "social");
        }
    ...
    public static class TimingBuilder extends HitBuilder<TimingBuilder> {
        public TimingBuilder() {
            C0138u.cU().m83a(C0137a.CONSTRUCT_TIMING);
            set("&t", "timing");
        }
    ...
    public static class TransactionBuilder extends HitBuilder<TransactionBuilder> {
        public TransactionBuilder() {
            C0138u.cU().m83a(C0137a.CONSTRUCT_TRANSACTION);
            set("&t", "transaction");
        }
