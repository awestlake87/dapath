...
public interface IGooglePlayServicesRocks extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGooglePlayServicesRocks {
        ...
        private static class C0600a implements IGooglePlayServicesRocks {
            private IBinder kq;
        ...
        public static IGooglePlayServicesRocks asInterface(IBinder obj) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IGooglePlayServicesRocks)) ? new C0600a(obj) : (IGooglePlayServicesRocks) queryLocalInterface;
        }
