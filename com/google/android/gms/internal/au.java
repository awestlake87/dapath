...
public final class au {
    ...
    private void aL() {
        try {
            C0252d U = this.my.mo1591U();
            if (U != null) {
                this.mA.addView((View) C1030e.m3259e(U));
            }
        } catch (Throwable e) {
    ...
    private void aM() throws RemoteException {
        ...
        if (this.lQ != null) {
            this.my.mo1594a(new ag(this.lQ));
        }
        if (this.mh != null) {
            this.my.mo1595a(new an(this.mh));
        }
        if (this.mB != null) {
            this.my.mo1596a(new dh(this.mB));
        }
        if (this.mC != null) {
            this.my.mo1597a(new dl(this.mC), this.mz);
        }
        aL();
    }
    ...
    public void m821a(at atVar) {
        try {
            ...
            if (this.my.mo1598a(this.mx.m783a(this.mA.getContext(), atVar))) {
    ...
    public void m822a(AdSize... adSizeArr) {
        ...
        try {
            if (this.my != null) {
                this.my.mo1593a(new al(this.mA.getContext(), this.mi));
            }
        } catch (Throwable e) {
    ...
    public void setAdListener(AdListener adListener) {
        try {
            this.lQ = adListener;
            if (this.my != null) {
                this.my.mo1594a(adListener != null ? new ag(adListener) : null);
            }
        } catch (Throwable e) {
    ...
    public void setAppEventListener(AppEventListener appEventListener) {
        try {
            ...
            if (this.my != null) {
                this.my.mo1595a(appEventListener != null ? new an(appEventListener) : null);
            }
        } catch (Throwable e) {
    ...
    public void setInAppPurchaseListener(InAppPurchaseListener inAppPurchaseListener) {
        ...
        try {
            ...
            if (this.my != null) {
                this.my.mo1596a(inAppPurchaseListener != null ? new dh(inAppPurchaseListener) : null);
            }
        } catch (Throwable e) {
    ...
    public void setPlayStorePurchaseParams(PlayStorePurchaseListener playStorePurchaseListener, String publicKey) {
        ...
        try {
            ...
            this.mz = publicKey;
            if (this.my != null) {
                this.my.mo1597a(playStorePurchaseListener != null ? new dl(playStorePurchaseListener) : null, publicKey);
            }
        } catch (Throwable e) {
